...
const FIXTURES: Record<FixtureType, Noun> = {
  ...
  [FixtureType.ForestVineSide]: noun({ bare: "Ranke", gender: "f", plural: "Ranken" }),
  [FixtureType.ForestVineCorner]: noun({ bare: "Ranke", gender: "f", plural: "Ranken" }),
  [FixtureType.ForestVineCornerUp]: noun({ bare: "Ranke", gender: "f", plural: "Ranken" }),
