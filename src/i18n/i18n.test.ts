...
function sample(p: Phrases): Record<string, string> {
  ...
  return {
    ...
    airshipTitle: p.airshipTitle,
    airshipAsk: p.airshipAsk("keel", 2),
    airshipReady: p.airshipReady,
    airshipBargain: p.airshipBargain,
    airshipEarned: p.airshipEarned,
    vennTitle: p.vennTitle,
    vennHint: p.vennHint,
    ...
    nextStep: p.nextStep,
    countingTitle: p.countingTitle,
    countingPutIn: p.countingPutIn,
    countingTakeOut: p.countingTakeOut,
